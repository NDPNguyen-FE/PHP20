  ...
  <table style="width: 100%">
    ...
    <tbody>
      ...
      for($i = 0; $i < count($newData); $i ++){?>
        <tr>
          <td><?php echo $newData[$i]['name'] ?></td>
          <td><?php echo $newData[$i]['email']?></td>
          <td><?php echo $newData[$i]['phone']?></td>
          <td><?php echo $newData[$i]['dob']?></td>
          <td><?php echo $newData[$i]['country']?></td>
          <td><?php echo $newData[$i]['city']?></td>
